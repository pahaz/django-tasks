...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChatUser.waiting_list'
        db.delete_column(u'chat_chatuser', 'waiting_list_id')
    ...
    def backwards(self, orm):
        # Adding field 'ChatUser.waiting_list'
        db.add_column(u'chat_chatuser', 'waiting_list',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chat.ChatUser'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        u'chat.chatuser': {
            ...
            'waiting_list': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'waiting_list_rel_+'", 'to': u"orm['chat.ChatUser']"})
        },
        u'chat.message': {
