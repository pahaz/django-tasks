...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = ChatUser
        fields = ['username', 'password', 'avatar', 'status', 'is_active', 'is_admin']
...
class ChatUserAdmin(UserAdmin):
    ...
    # overrides get_fieldsets to use this attribute when creating a user.t
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
...
class MesAdmin(admin.ModelAdmin):
    list_display = ('id', 'from_user', 'to_user', 'datetime', 'message', 'is_read')
